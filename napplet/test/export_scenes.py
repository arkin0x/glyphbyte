...
usage: PYTHONPATH=. python napplet/test/export_scenes.py <out_dir> [n] [seed] [format]"""
import json, os, sys
...
for i in range(n):
    ...
    items.append({'i': i, 'hex': sc.data.hex(), 'format': fmt,
